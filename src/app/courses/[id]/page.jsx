...
import { FiClock, FiUser, FiStar, FiLock } from "react-icons/fi";
    ...
    const checkAccess = async () => {
      ...
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/api/student/courses/${course._id}/access`,
        ...
        <div className="lg:col-span-2 space-y-12">
          ...
          <div className="bg-white p-5 rounded-xl shadow-md border">
            ...
            {hasAccess ? (
              ...
              <div className="relative w-full h-64 md:h-96 rounded-xl bg-gray-300 flex items-center justify-center">
                <Image
                  src={course.thumbnail}
                  fill
                  alt="Locked"
                  ...
                  unoptimized
                />
                <span className="text-white text-5xl z-10 absolute">
                  <FiLock />
                </span>
              </div>
            )}
            ...
            {!hasAccess ? (
              ...
              <div className="flex flex-col gap-3">
                ...
                <button
                  ...
                  className="w-full bg-gray-600 hover:bg-gray-700 text-white py-3 rounded-xl text-lg font-semibold transition"
                >
                  Go to Dashboard
                </button>
              </div>
